                ...
                if (that._isInput) {
                   debugger;
                    ...
                    if(mat.indexOf("yy")!=-1){
                        ...
                        hhInt++;
                        iiInt++;
                        str+=parseFloat(that._tempWheelArray[0])+that.optionInput.yearText;
                    }
                    if(mat.indexOf("mm")!=-1){
                        str+=parseFloat(that._tempWheelArray[mouthInt])+1+that.optionInput.monthText;
                        ddInt++;
                        hhInt++;
                        iiInt++;
                    }
                    if(mat.indexOf("dd")!=-1){
                        str+=parseFloat(that._tempWheelArray[ddInt])+that.optionInput.dayText;
                        hhInt++;
                        iiInt++;
                    }
                    if(mat.indexOf("HH")!=-1){
                        str+=parseFloat(that._tempWheelArray[hhInt])+that.optionInput.hourText;
                        iiInt++;
                    }
                    if(mat.indexOf("ii")!=-1){
                        str+=parseFloat(that._tempWheelArray[iiInt])+that.optionInput.minuteText;
                    }
                    /*for(var i = 0;i<that._tempWheelArray.length;i++){

                    }*/
                   // that.option();
                    $elm.val(that._hasValue ? str : '');
                    if (change) {
