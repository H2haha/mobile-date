(function ($, undefined) {
        ...
        preset = function (inst) {
           ...
           // debugger;
            ...
            var i,
                ...
                ampm = tord.match(/a/i),
                hampm = tord.match(/h/),
                hformat = p == 'datetime' ? s.dateFormat + s.separator + s.timeFormat : p == 'time' ? s.timeFormat :p=="dateHouMon"?"HH:ii:ss": s.dateFormat,
                defd = new Date(),
                stepH = s.stepHour,
                stepM = s.stepMinute,
                stepS = s.stepSecond,
    ...
    $.each(['date', 'time', 'datetime',"dateHouMon"], function (i, v) {
